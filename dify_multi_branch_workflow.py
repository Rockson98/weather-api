#!/usr/bin/env python3
"""
Dify多支路工作流 - 天气播报、散文生成、图片生成
将复杂工作流拆分为三个独立支路，提高稳定性和可维护性
"""
...
def main(arg1, arg2):
    ...
    return {
        ...
        "prose_context": f"城市：{city}，天气：{weather_desc}，温度：{temperature}°C",
        
        # 支路3: 图片生成
        "image_prompt": image_prompt,
        "image_description": f"{city}的{weather_desc}天气景象",
